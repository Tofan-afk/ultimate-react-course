  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        />
        {showAddFriend && (
          <FormAddFriend setFriends={setFriends} show={handleShowAddFriend} />
        )}
...
function FormAddFriend({ setFriends, show }) {
  ...
  function handleSubmit(e) {
    ...
    return setFriends((f) => [...f, newFriend]);
  }
...
function FormSplitBill({ selection, onSplitBill }) {
  ...
  function handleSubmit(e) {
    ...
    onSplitBill(who === "user" ? paidByFriend : -paidByUser);
  }
